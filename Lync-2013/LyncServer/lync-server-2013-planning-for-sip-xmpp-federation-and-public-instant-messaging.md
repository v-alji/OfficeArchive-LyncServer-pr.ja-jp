...
一部の状況では、インスタントメッセージング (IM) や Microsoft Lync Server 2013 との間のプレゼンス (XMPP) の連絡先との間での通信が、ピアツーピアのみになります。フェデレーションパートナーとの連絡のみをサポートします。 Lync server、lync server 2010、lync Server 2013 フェデレーションなどの場合、複数の参加者が会話に参加するよう招待することができます。
