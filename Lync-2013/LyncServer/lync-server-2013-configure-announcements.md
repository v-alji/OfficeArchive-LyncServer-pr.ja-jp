...
---
# <a name="configure-announcements-in-lync-server-2013"></a>Lync Server 2013 でお知らせを設定する
...
## <a name="in-this-section"></a>このセクション中
  ...
  - [Lync Server 2013 でお知らせを削除する](lync-server-2013-delete-an-announcement.md)
