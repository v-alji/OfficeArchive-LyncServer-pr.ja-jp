...
4.  インポートされた応答グループを表示して、インポートが正常に完了したことを確認します。 インポートされた応答グループは、依然としてプライマリプールによって所有されます。 以下の操作を行います。
...
10. インポートされた応答グループの構成を表示して、プライマリプールへのインポートが正常に完了したことを確認します。 以下の操作を行います。
