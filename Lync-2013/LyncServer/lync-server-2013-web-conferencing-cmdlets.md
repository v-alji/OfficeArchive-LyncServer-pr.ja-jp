...
Lync Server 2013 を構成および管理するためのその他の方法については、 [新しい csclientpolicy](https://technet.microsoft.com/library/Gg425949(v=OCS.15)) と [Set の](https://technet.microsoft.com/library/Gg398300(v=OCS.15)) clientpolicy コマンドレットをご用意しています。
