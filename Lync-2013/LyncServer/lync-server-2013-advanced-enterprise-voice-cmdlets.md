---
title: 'Lync Server 2013: 高度なエンタープライズボイスコマンドレット'
description: 'Lync Server 2013: 高度なエンタープライズボイスコマンドレット。'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "49439976"
---
# <a name="advanced-enterprise-voice-cmdlets-in-lync-server-2013"></a>Lync Server 2013 の高度なエンタープライズボイスコマンドレット
...
エンタープライズ Voip を組織に実装すると、ユーザーエクスペリエンスと組織の効率を向上させるための追加の機能とアプリケーションを実装するためのオプションも提供されます。 これらの機能には、通話受付制御、強化された 9-1-1 (E9) 緊急通話、メディア構成の設定などがあります。

<div>

## <a name="advanced-enterprise-voice-cmdlets"></a>高度なエンタープライズボイスコマンドレット

次の一覧には、エンタープライズ Voip 展開の高度な機能を管理するためのコマンドレットが含まれています。

**[Lync Server 2013 での通話受付制御コマンドレット](lync-server-2013-call-admission-control-cmdlets.md)**
...
**[Lync Server 2013 の強化された9-1-1 コマンドレット](lync-server-2013-enhanced-9-1-1-cmdlets.md)**
...
**[共有線の外観 (SLA) コマンドレット](shared-line-appearance-sla-cmdlets.md)**
...
**[Lync Server 2013 でのメディアバイパスのコマンドレット](lync-server-2013-media-bypass-cmdlets.md)**
...
**[Lync Server 2013 のメディア構成コマンドレット](lync-server-2013-media-configuration-cmdlets.md)**
