...
Exchange ユニファイドメッセージングにユーザーを移行するには、次のタスクが含まれます。
  ...
  - ユーザーが Exchange ユニファイドメッセージングの通話応答と Outlook Voice Access を使用できるようにします。 このタスクは、Exchange ユニファイドメッセージングサーバー上で実行されます。 詳細については、「Exchange Server 2010 TechNet ライブラリ」を参照してください [https://go.microsoft.com/fwlink/p/?linkID=139372](https://go.microsoft.com/fwlink/p/?linkid=139372) 。
