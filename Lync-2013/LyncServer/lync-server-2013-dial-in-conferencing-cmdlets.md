...
description: 'Lync Server 2013: ダイヤルイン会議のコマンドレット。'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ダイヤルイン会議を許可したくない場合は、Set-CsConferencingPolicy コマンドレットを使用して、Enabledial In会議プロパティを False に設定することで、この機能を無効にすることができます。 既定では、すべてのユーザーは、ダイヤルイン会議を含む会議を主催することができます。
