...
---
# <a name="backup-and-high-availability-cmdlets-in-lync-server-2013"></a>Lync Server 2013 のバックアップと高可用性のコマンドレット
...
バックアップと高可用性のコマンドレットを使用すると、管理者は Microsoft Lync Server 2013 で導入されたプールのバックアップ、復元、高可用性の機能を管理できます。

<div>

## <a name="backup-and-high-availability-cmdlets"></a>バックアップと高可用性のコマンドレット

次に、Lync Server トポロジのバックアップと可用性の設定に直接関連するコマンドレットの一覧を示します。
