...
---
# <a name="appendices-survivable-branch-appliances-and-servers-in-lync-server-2013"></a>付録: Lync Server 2013 の存続可能ブランチ アプライアンスとサーバー
...
このセクションには、Survivable Branch アプライアンスと Survivable ブランチサーバーに関する追加情報が記載されています。
...
## <a name="in-this-section"></a>このセクション中
  ...
  - [付録 B: Lync Server 2013 での存続可能ブランチ アプライアンスの管理](lync-server-2013-appendix-b-managing-a-survivable-branch-appliance.md)
