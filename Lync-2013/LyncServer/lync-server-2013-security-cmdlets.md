...
Microsoft Lync Server 2013 に含まれているセキュリティコマンドレットは、主に認証、ユーザー権利、アクセス許可を管理するために使用されます。 認証の管理には、さまざまなコマンドレット (証明書と暗証番号 (PIN) の認証用のコマンドレットなど) を使用できます。 さらに、いくつかのコマンドレットを使用して、新しいロールベースのアクセス制御 (RBAC) 機能を使用して、Lync Server の管理制御を委任することができます。

<div>

## <a name="security-cmdlets"></a>セキュリティコマンドレット

セキュリティ設定に適用される多くの管理タスクは、Lync Server コントロールパネルから実行できます。 重要な例外の1つは、ユーザー権限のコマンドレットです。 ただし、すべてのセキュリティ管理タスクは、Lync Server 管理シェルから、またはスクリプト内からコマンドレットを使用して実行できます。スクリプトを使用すると、特定のタスクを自動化できます。 セキュリティ設定の管理に直接関連するコマンドレットの一覧を次に示します。

**[Lync Server 2013 の証明書と認証コマンドレット](lync-server-2013-certificate-and-authentication-cmdlets.md)**
...
**[Lync Server 2013 のユーザー権利と権限のコマンドレット](lync-server-2013-user-rights-and-permissions-cmdlets.md)**
...
**[Lync Server 2013 の相互運用性コマンドレット](lync-server-2013-interoperability-cmdlets.md)**
