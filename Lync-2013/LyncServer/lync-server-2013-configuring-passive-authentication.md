...
1.  Lync Server 管理シェルのコマンドラインで、次のコマンドを実行して、累積更新プログラムを使用して、各 Lync Server 2013 の新しいプロキシ構成を作成します。2013エッジプール、エンタープライズプール、Standard Edition Server は、次のコマンドを実行します。
