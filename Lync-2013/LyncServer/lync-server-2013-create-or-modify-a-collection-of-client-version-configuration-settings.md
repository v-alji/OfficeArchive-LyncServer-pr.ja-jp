...
詳細については、「 [新しい-CsClientVersionConfiguration](https://technet.microsoft.com/library/Gg399029(v=OCS.15)) ()」と「 [csclientversionconfiguration](https://technet.microsoft.com/library/Gg398623(v=OCS.15)) コマンドレットを設定する」のヘルプトピックを参照してください。
