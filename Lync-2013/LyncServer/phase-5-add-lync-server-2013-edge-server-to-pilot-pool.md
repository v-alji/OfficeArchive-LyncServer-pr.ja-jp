...
---
# <a name="phase-5-add-lync-server-2013-edge-server-to-pilot-pool"></a>フェーズ 5: Lync Server 2013 エッジサーバーをパイロットプールに追加する
...
このセクションのトピックでは、パイロットプールの展開に Lync Server 2013 Edge サーバーを追加する方法について説明します。 このトピックでは、[新しい Edge プールの展開] ウィザードを実行するときの構成と検証のガイダンスを提供します。
