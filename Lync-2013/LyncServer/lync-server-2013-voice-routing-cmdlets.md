...
---
# <a name="voice-routing-cmdlets-in-lync-server-2013"></a>Lync Server 2013 の音声ルーティングコマンドレット
...
音声ルートには、Microsoft Lync Server 2013 で、エンタープライズボイスユーザーから公衆交換電話網 (PSTN) または構内交換機 (PBX) 上の電話番号に着信をルーティングする方法について説明する手順が含まれています。

<div>

## <a name="voice-routing-cmdlets"></a>音声ルーティングコマンドレット

ボイスルーティングを構成するには、次のコマンドレットを使用します。
...
[Lync Server 2013 の PSTN 接続コマンドレット](lync-server-2013-pstn-connectivity-cmdlets.md)  
