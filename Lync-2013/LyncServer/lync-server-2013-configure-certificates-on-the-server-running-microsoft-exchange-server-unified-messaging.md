...
Exchange ユニファイドメッセージング (UM) を展開している場合、計画ドキュメントの「 [Lync Server 2013 での Exchange ユニファイドメッセージングの統合の計画](lync-server-2013-planning-for-exchange-unified-messaging-integration.md) 」で説明されているように、組織内のエンタープライズ voip 機能を提供するには、次の手順を使用して、exchange um を実行しているサーバーで証明書を構成します。
...
1.  Exchange UM を実行しているサーバーで、[**スタート**] をクリックし、[**実行**] をクリックして、http://のように入力し、[ **OK]** をクリックします。 **\<name of your Issuing CA Server\>**
...
1.  Exchange UM を実行しているサーバーで、[**スタート**]、[**実行**]、[**名前** を指定して実行 **] の順にクリック** し、[ **OK**] をクリックして、Microsoft 管理コンソール (mmc) を開きます。
...
1.  詳細については、Exchange Server のドキュメントの「Exchange 2013 UM と Lync Server の統合」を参照してください [https://go.microsoft.com/fwlink/p/?LinkId=265372](https://go.microsoft.com/fwlink/p/?linkid=265372) 。
...
1.  適切なユーザー権限を持つ Exchange UM を実行しているサーバーにログオンします。 詳細については、の「クライアントアクセス許可」を参照してください [https://go.microsoft.com/fwlink/p/?linkId=195499](https://go.microsoft.com/fwlink/p/?linkid=195499) 。
...
2.  証明書を割り当てる手順については、の「証明書にサービスを割り当てる」を参照してください [https://go.microsoft.com/fwlink/p/?linkId=195497](https://go.microsoft.com/fwlink/p/?linkid=195497) 。
