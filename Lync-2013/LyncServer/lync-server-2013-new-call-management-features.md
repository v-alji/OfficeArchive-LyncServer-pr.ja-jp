...
---
# <a name="new-call-management-features-in-lync-server-2013"></a>Lync Server 2013 の新しい通話管理機能
...
以下のセクションでは、Lync Server 2013 の通話管理機能の変更について説明します。
  ...
  - [Lync Server 2013 の新しいグループ通話のピックアップ機能](lync-server-2013-new-group-call-pickup-feature.md)
